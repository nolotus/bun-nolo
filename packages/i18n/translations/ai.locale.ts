export default {
  en: {
    translation: {
      ...
      update: "Create",
      updating: "Creating...",
      useServerProxy: "Direct Connection",
      ...
      privacy: "Privacy",
      proxyHelp:
        "Use your API key to connect directly without going through our servers",
  ...
  "zh-CN": {
    translation: {
      ...
      capabilities: "功能配置",
      privacy: "隐私设置",
      proxyHelp: "使用您的API密钥直接连接,无需经过我们的服务器",
  ...
  "zh-Hant": {
    translation: {
      ...
      capabilities: "功能配置",
      privacy: "隱私設置",
      proxyHelp: "使用您的API密鑰直接連接,無需經過我們的服務器",
  ...
  ja: {
    translation: {
      ...
      capabilities: "機能設定",
      privacy: "プライバシー設定",
      proxyHelp: "APIキーを使用して当社サーバーを経由せずに直接接続",
      proxyNotAvailableForProvider:
