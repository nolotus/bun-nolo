...
const BetaAccessSignup: React.FC = () => {
  ...
  return (
    <div className="beta-access-container">
      <style>{`
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="beta-access-form">
        <h1 className="beta-access-title">
          {t("betaAccess")}
...
export default BetaAccessSignup;
